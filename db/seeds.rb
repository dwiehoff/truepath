...
q3 = Question.create!(text: "Do you prefer to work in a creative or in an more analytical way?")
...
q7 = Question.create!(text: "Are you thinking/planing things through or rather deal with problems when they come up?")
q8 = Question.create!(text: "Do you like working on one main task/ product after another or do you want to experience diversity in your worklife?")
